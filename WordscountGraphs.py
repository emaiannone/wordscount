...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/init_strong.png')
...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/wordscount_strong.png')
...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/global_strong.png')
...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/init_weak.png')
...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/wordscount_weak.png')
...
mpl.ylabel("Time (ms)")
mpl.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), shadow=True, ncol=5)
mpl.savefig('figures/global_weak.png')
